...
#### 🛠 Tech stack
`React.js` `Next.js` `Tailwind CSS` `MUI` `Framer Motion` `MongoDB` `REST APIs` `Figma` `Adobe XD` `Sanity CMS` `SEO` `Git`
...
| Meera Regency | Hotel website with booking interface | [meera-regency.vercel.app](https://meera-regency.vercel.app) |

---

#### 📬 Connect with me
- 🌐 Portfolio: [hireparth.netlify.app](https://hireparth.netlify.app)
- 🎨 Behance: [behance.net/parthjathar](https://behance.net/parthjathar)
- 📧 Email: parth.jathar7@gmail.com
